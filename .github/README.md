...
[`@aws-sdk/client-cloud9`](https://www.npmjs.com/package/@aws-sdk/client-cloud9/v/3.159.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloud9@3.159.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vT+n8TaePyIT+7hnsG+3Tvx3KGdqm5JNe4IQ8zIdzSvnHCb7JnUMFIbLP8OR+qP8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-cloud9": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloud9@3.159.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cloud9@3.159.0/index.min.mjs": "sha384-vT+n8TaePyIT+7hnsG+3Tvx3KGdqm5JNe4IQ8zIdzSvnHCb7JnUMFIbLP8OR+qP8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-cloud9/blob/refs/tags/3.159.0/LICENSE
```
